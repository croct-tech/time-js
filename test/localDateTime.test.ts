...
describe('A value object representing a local date time', () => {
    ...
    it.each(Object.entries<DurationBetweenScenario>({
        '2015-08-31T00:00:00/2015-08-31T00:00:00': {
            start: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(0, 0, 0, 0)),
            end: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(0, 0, 0, 0)),
            duration: Duration.zero(),
        },
        '2015-08-31T00:00:00/2015-08-31T01:02:03.000000004': {
            start: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(0, 0, 0, 0)),
            end: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(1, 2, 3, 4)),
            duration: Duration.ofSeconds(3600 + 2 * 60 + 3, 4),
        },
        ...
        '2015-08-31T00:00:02.000000005/2015-08-31T00:00:01.000000009': {
            start: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(0, 0, 2, 5)),
            end: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(0, 0, 1, 9)),
            duration: Duration.ofSeconds(-1, 4),
        },
        '2015-08-31T00:00:02.000000005/2015-08-31T00:00:03.000000001': {
            start: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(0, 0, 2, 5)),
            end: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(0, 0, 3, 1)),
            duration: Duration.ofSeconds(1, -4),
        },
        '2015-08-30T00:00:00/2015-08-31T00:00:00': {
            start: LocalDateTime.of(LocalDate.of(2015, 8, 30), LocalTime.of(0, 0, 0, 0)),
            end: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(0, 0, 0, 0)),
            duration: Duration.ofSeconds(24 * 3600),
        },
        '2015-08-31T00:00:00/2015-08-30T00:00:00': {
            start: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(0, 0, 0, 0)),
            end: LocalDateTime.of(LocalDate.of(2015, 8, 30), LocalTime.of(0, 0, 0, 0)),
            duration: Duration.ofSeconds(-24 * 3600),
        },
        '2015-08-30T01:02:03.000000004/2015-08-31T00:00:00': {
            start: LocalDateTime.of(LocalDate.of(2015, 8, 30), LocalTime.of(1, 2, 3, 4)),
            end: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(0, 0, 0, 0)),
            duration: Duration.ofSeconds(24 * 3600 - 3600 - 2 * 60 - 3, -4),
        },
        '2015-08-31T00:00:00/2015-08-30T01:02:03.000000004': {
            start: LocalDateTime.of(LocalDate.of(2015, 8, 31), LocalTime.of(0, 0, 0, 0)),
            end: LocalDateTime.of(LocalDate.of(2015, 8, 30), LocalTime.of(1, 2, 3, 4)),
            duration: Duration.ofSeconds(-24 * 3600 + 3600 + 2 * 60 + 3, 4),
        },
        '-0001-01-01T01:02:03.000000004/0001-12-31T00:00:00': {
            start: LocalDateTime.of(LocalDate.of(-1, 1, 1), LocalTime.of(1, 2, 3, 4)),
            end: LocalDateTime.of(LocalDate.of(1, 12, 31), LocalTime.of(0, 0, 0, 0)),
            duration: Duration.ofSeconds(26278 * 3600 + 57 * 60 + 56, 999999996),
        },
        '0001-12-31T00:00:00/-0001-01-01T01:02:03.000000004': {
            start: LocalDateTime.of(LocalDate.of(1, 12, 31), LocalTime.of(0, 0, 0, 0)),
            end: LocalDateTime.of(LocalDate.of(-1, 1, 1), LocalTime.of(1, 2, 3, 4)),
            duration: Duration.ofSeconds(-26278 * 3600 - 57 * 60 - 56, -999999996),
        },
        '-999999-01-01T01:02:03.000000004/999999-12-31T00:00:00': {
            start: LocalDateTime.of(LocalDate.of(-999999, 1, 1), LocalTime.of(1, 2, 3, 4)),
            end: LocalDateTime.of(LocalDate.of(999999, 12, 31), LocalTime.of(0, 0, 0, 0)),
            duration: Duration.ofSeconds(17531631190 * 3600 + 57 * 60 + 56, 999999996),
        },
        '999999-12-31T00:00:00/-999999-01-01T01:02:03.000000004': {
            start: LocalDateTime.of(LocalDate.of(999999, 12, 31), LocalTime.of(0, 0, 0, 0)),
            end: LocalDateTime.of(LocalDate.of(-999999, 1, 1), LocalTime.of(1, 2, 3, 4)),
            duration: Duration.ofSeconds(-17531631190 * 3600 - 57 * 60 - 56, -999999996),
        },
